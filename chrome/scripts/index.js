...
/** @type {Record<ContentScriptName, Array<chrome.scripting.RegisteredContentScript>>} */
export const availableContentScripts = {
  ...
  SignInDarkMode: [
    ...
    {
      id: 'SignInDarkModeSaml',
      css: ['scripts/SignInDarkModeSaml.css'],
      matches: [
  ...
  RememberSAMLRole: [
    {
      id: 'RememberSAMLRole',
      js: ['scripts/RememberSAMLRole.js'],
